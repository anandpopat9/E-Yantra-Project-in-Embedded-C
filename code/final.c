...
#define WLTHRESHOLD 40 //black if more than threshold, white if l
...
#define ir_proxi_5 8
#define sharp_ir_1 9
#define sharp_ir_2 10
#define sharp_ir_3 11
#define sharp_ir_4 12
#define sharp_ir_5 13
